  ...
  return (
    <div className="grid w-full grid-cols-1 h-auto gap-4 py-4 my-2 sm:px-8 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:px-16 border-b-8 border-[#E0004D] ">
      <div className="flex flex-col justify-center py-4 pt-4 m-0">
        <h2 className="inline-block px-4 py-2 font-sans text-4xl font-bold bg-blueP w-max">
          <Typewriter
            words={[t("h1")]}
            loop={false}
            cursor
      ...
      <div className="">
        ...
        <div className="flex flex-col items-center justify-center p-8">
          <img
            src="/Aboutme.png"
            alt="logo"
            className="w-auto rounded-full h-80 sm:h-80 sm:h-120 md:h-120 lg:h-120 xl:h-120 bg-blueP "
          />{" "}

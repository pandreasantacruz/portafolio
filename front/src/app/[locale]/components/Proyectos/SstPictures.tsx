...
const CarouselSST = () => {
  ...
  return (
    <div className="flex flex-col max-w-full gap-6 pb-4 overflow-hidden text-black bg-white md:flex-row dark:bg-blackP dark:text-white">
      ...
      {/* Texto */}
      <div className="flex font-sans flex-col justify-center w-full max-w-md px-4 space-y-4 md:px-0">
        <p className="text-lg font-medium text-justify break-words font-sans">
          {t("SSTH1")}
        </p>
        <p className="text-lg font-medium text-justify break-words font-bebas">
          {tP("Pr")}
        </p>
        <p className="text-lg text-justify break-word font-sans">
          {t("SSTH2")}
        </p>
